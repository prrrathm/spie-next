			...
			<main className="m-0">
				...
				>
					<div className="inline-flex flex-col gap-5 bg-black/70 md:w-[80%] rounded-xl items-center p-10 pt-6 min-h-[80vh] drop-shadow-2xl">
						...
						<div className="">
							...
							<h2
								id="about"
								className="text-[5rem] font-black flex flex-col items-end"
							>
								About
				...
				<section className="flex-col !min-h-[100vh] sticky top-0">
					<h2 className="text-[5rem] font-black">
						Our Annual report for the year 2022
						<a
							href=""
							className="rounded bg-red-700 text-black hover:bg-black hover:text-red-700 px-4 py- ml-6 border-2 border-red-700 text-[2rem]"
						>
							Read More
						</a>
					</h2>
